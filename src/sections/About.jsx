      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 200 }}>
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.8)', marginBottom: 12 }}>
            DevOps & Site Reliability Engineer · Houston, TX
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, minWidth: 180 }}>
          {[
            { emoji: '📧', val: 'maneeshwar132@gmail.com' },
            { emoji: '📱', val: '346-638-2834' },
          ].map(({ emoji, val }) => (
        ...
        {activeTab === 'personal' && (
          <>
            <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 10, padding: '18px 22px' }}>
              ...
              <InfoRow icon="📧" label="Email" value="maneeshwar132@gmail.com" highlight t={t} />
              <InfoRow icon="📱" label="Phone" value="346-638-2834" t={t} />
            ...
            <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 10, padding: '18px 22px' }}>
              ...
              <div style={{ fontSize: 13, color: t.textMuted, lineHeight: 1.8, marginBottom: 14 }}>
                Results-driven DevOps and Site Reliability Engineer with <strong style={{ color: t.text }}>2+ years</strong> of experience building CI/CD pipelines, managing cloud infrastructure across <strong style={{ color: t.text }}>AWS and Azure</strong>, and ensuring microservice resilience. Completed an <strong style={{ color: t.text }}>M.S. in Engineering Data Science</strong> at the University of Houston (GPA 3.9/4.0, May 2026).
              </div>
            ...
            <div style={{ background: t.surface, border: `1px solid ${t.border}`, borderRadius: 10, padding: '18px 22px' }}>
              ...
              <div style={{ marginTop: 12, padding: '12px 14px', background: `${t.accent}08`, border: `1px solid ${t.accent}20`, borderRadius: 8 }}>
                <div style={{ fontSize: 12, color: t.textMuted, lineHeight: 1.7 }}>
                  After completing undergrad, joined industry immediately accumulating <strong style={{ color: t.text }}>2+ years of hands-on DevOps & SRE experience</strong> before returning to academia for Master's degree.
                </div>
              </div>
            </div>
          </>
