  ...
  return (
    <section id="overview" style={{ marginBottom: 36 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 220 }}>
          ...
          <div style={{ fontSize: 13, color: '#605e5c', lineHeight: 1.8, maxWidth: 680 }}>
            Results-driven DevOps and Site Reliability Engineer with 2+ years of experience building
            CI/CD pipelines, managing cloud infrastructure across AWS and Azure, and ensuring
            microservice resilience. Completed M.S. Engineering Data Science at University of Houston (GPA 3.9/4.0, May 2026).
          </div>
        </div>

        <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
          {[
            ['📧', 'maneeshwar132@gmail.com'],
            ['📱', '346-638-2834'],
            ['📍', 'Houston, TX'],
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
        <KpiCard label="Years Experience"     value="2+"      sub="DevOps & Cloud"       icon="⚡" color="#0078d4" />
