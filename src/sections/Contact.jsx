...
const CONTACTS = [
  { label: 'Email',    value: 'maneeshwar132@gmail.com',        icon: '📧', href: 'mailto:maneeshwar132@gmail.com',          color: '#0078d4' },
  { label: 'Phone',    value: '346-638-2834',                   icon: '📱', href: 'tel:3466382834',                          color: '#107c10' },
