    ...
    <div style={{ position:'fixed', top:48, left:0, bottom:0, width:w, background:t.sidebarBg, borderRight:`1px solid ${t.border}`, zIndex:100, transition:'width 0.2s ease', overflow:'hidden', display:'flex', flexDirection:'column' }}>
        ...
        <div style={{ padding:'16px', borderBottom:`1px solid ${t.border}` }}>
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize:11, color:t.textMuted }}>DevOps Engineer</div>
            </div>
          </div>
      ...
      {!collapsed && (
        <div style={{ borderTop:`1px solid ${t.border}`, padding:'12px 16px' }}>
          <a href="mailto:maneeshwar132@gmail.com" style={{ fontSize:12, color:'#0078d4', textDecoration:'none', display:'block', marginBottom:5 }}>📧 maneeshwar132@gmail.com</a>
          <a href="tel:3466382834" style={{ fontSize:12, color:'#0078d4', textDecoration:'none', display:'block' }}>📱 346-638-2834</a>
        </div>
      )}
    </div>
  );
